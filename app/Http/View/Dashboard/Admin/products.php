...
<div class="col-1-1">
    <h1>Products</h1>
    <input type="search" class="slide purple-slide table-search" data-table="Products" placeholder="Filtrer" />
    <script>
        (function(document) {
            'use strict';
    ...
    <div id="table" class="table-editable">
        ...
        <table class="Products">
            ...
            <tr>
                <?php
                $Products = $this->content['data'];
                echo "<th>" . implode('</th> <th>',  array_keys($Products[0])) . "</th>";
                ?>
            </tr>
            </thead>
            <tbody>
            <?php
            for($i = 0; $i < count(array_keys($Products)); $i++)
            {
                ?>
                <tr>
                <?php
                foreach($Products[$i] as $key => $order) {
                ?>
            ...
            <tr class="hide">
                <?php for($i = 0; $i < count(array_keys($Products)); $i++)
                {
    ...
    <form id="postform" class="hide" action="<?php echo app::currentUrl(false, true) ?>Products/modify" method="post">
