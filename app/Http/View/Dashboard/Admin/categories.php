...
<div class="grid grid-pad">
    ...
    <div class="col-1-1">
        <h1>Categories</h1>
        <input type="search" class="slide purple-slide table-search" data-table="Categories" placeholder="Filtrer" />
        <script>
            (function(document) {
                'use strict';
        ...
        <div id="table" class="table-editable">
            ...
            <table class="Categories">
                ...
                <tr>
                    <?php
                    $Categories = $this->content['data'];
                    echo "<th>" . implode('</th> <th>',  array_keys($Categories[0])) . "</th>";
                    ?>
                </tr>
                </thead>
                <tbody>
                ...
                for($i = 0; $i < count(array_keys($Categories)); $i++)
                {
                    ...
                    <tr>
                        <?php
                        foreach($Categories[$i] as $key => $order) {
                            ?>
                ...
                <tr class="hide">
                    <?php for($i = 0; $i < count(array_keys($Categories)); $i++)
                    {
        ...
        <form id="postform" class="hide" action="<?php echo app::currentUrl(false, true) ?>Categories/modify" method="post">
