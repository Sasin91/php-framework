...
<div class="jumbotron container" style="border-radius: 4px;">
	...
	<div class="container-fluid pull-left">
		<div class="row-fluid">
			<div class="col-md-2">
				<img class="img img-rounded img-responsive" src="<?php echo $this->app->config()->url;?>/Assets/img/users/<?php echo $profile['user'][0]->image;?>" width="200px" height="200px">
			</div>

			<div class="col-md-4">
				<h1>Greetings,  <?php echo $profile['user'][0]->username;?></h1>
				<blockquote>
					<p>Rank: <?php echo $profile['rank'][0]->name;?>, Position: <?php echo $profile['membership'][0]->position; ?></p> <small><cite title="Source Title"><?php echo $profile['user'][0]->location;?>  <i class="glyphicon glyphicon-map-marker"></i></cite></small>
				</blockquote>
